...
//! VER EN TRUCK MANAGEMENT COMO FUE UTILIZADO ESTE COMPONENTE PARA MOSTRAR LOS ERRORES. JUNTO CON EL FORMATEADOR DE ERRORES EN UTILS.TS
  ...
  'relative w-full rounded-lg border px-4 py-3 text-sm',
  {
    variants: {
      variant: {
        ...
        danger:
          'text-danger bg-red-200 text-red-900 border-red-400 [&>svg]:text-current *:data-[slot=alert-description]:text-destructive/90',
        info: 'bg-primary text-white border-primary-400',
