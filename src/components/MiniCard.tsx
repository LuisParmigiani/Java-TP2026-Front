...
export default function MiniCard({ svg, title, description }: MiniCardProps) {
    return (
        <div className="group w-full h-full bg-card rounded-xl p-7 flex flex-col items-center text-center sm:items-start md:text-left border-2 border-black shadow-md transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-2xl hover:border-primary">
