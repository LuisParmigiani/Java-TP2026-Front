                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <span className="font-bold text-xl text-foreground">Sodas Rojas</span>
                        </div>
                        <p className="text-sm leading-relaxed">
                            Distribuidora de refrescos y agua purificada. Servicio a domicilio rápido y confiable en toda la ciudad.
                        </p>
                    </div>

                    {/* Contact */}
                    <div>
                        <h3 className="font-semibold text-foreground mb-4 text-lg">Contacto</h3>
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <span className="text-sm">contacto@sodasrojas.com</span>
                            </div>
                    ...
                    {/* Links */}
                    <div>
                        <h3 className="font-semibold text-foreground mb-4 text-lg">Enlaces Rápidos</h3>
                        <div className="space-y-2 flex flex-col">
                            <LinkPhrase text="Inicio" url="/" size="md" color="blackPrimary" />
                            <LinkPhrase text="Productos" url="/products" size="md" color="blackPrimary" />
