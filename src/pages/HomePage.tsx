...
export default function HomePage() {
  ...
  useEffect(() => {
    const fetchProductos = async () => {
      try {
        const response = await getActiveProducts(token);
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="relative w-full min-h-[600px] flex items-center justify-center bg-muted overflow-hidden">
          ...
          <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-foreground mb-6 leading-tight w-2/3 ">
              Las mejores bebidas,{" "}
              <span className="text-primary">directo a tu puerta.</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl leading-relaxed">
              Sodas Rojas es tu distribuidora de confianza. Ofrecemos una amplia
              variedad de refrescos y agua purificada con entrega rápida y
              segura.
            </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                ¿Por qué elegir Sodas Rojas?
              </h2>
              <p className="text-muted-foreground text-xl text-gray-500 ">
                Nos dedicamos a brindarte el mejor servicio de distribución con
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
              <MiniCard
                  ...
                  >
                    ...
                    <g id="SVGRepo_iconCarrier">
                      ...
                      <g>
                        ...
                        <g>
                          {" "}
                          <path d="M110.933,320c-28.237,0-51.2,22.963-51.2,51.2c0,28.237,22.963,51.2,51.2,51.2s51.2-22.963,51.2-51.2 C162.133,342.963,139.17,320,110.933,320z M110.933,405.333c-18.825,0-34.133-15.309-34.133-34.133s15.309-34.133,34.133-34.133 s34.133,15.309,34.133,34.133S129.758,405.333,110.933,405.333z"></path>{" "}
                        </g>{" "}
                      </g>{" "}
                      <g>
                        {" "}
                        <g>
                          {" "}
                          <path d="M396.919,320c-28.237,0-51.2,22.963-51.2,51.2c0,28.237,22.963,51.2,51.2,51.2c28.237,0,51.2-22.963,51.2-51.2 C448.12,342.963,425.148,320,396.919,320z M396.919,405.333c-18.825,0-34.133-15.309-34.133-34.133s15.309-34.133,34.133-34.133 s34.133,15.309,34.133,34.133S415.735,405.333,396.919,405.333z"></path>{" "}
                        </g>{" "}
                      </g>{" "}
                      <g>
                        {" "}
                ...
                description="Llevamos tus productos directamente a tu puerta."
              />
              <MiniCard
                svg={
                  <svg
                    className="w-15/16 h-15/16 p-auto m-auto"
                    viewBox="0 0 24 24"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                description="Configura entregas semanales automáticas"
              />
              ...
              <MiniCard
                ...
                description="La mejor calidad en agua y bebidas"
              />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-muted/50 border-y border-border bg-gray-200">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              ...
              <div className="flex flex-row items-center justify-between mb-8">
                <p className="text-muted-foreground text-lg">
                  Descubre nuestras bebidas más populares.
                </p>
                <LinkButton
        ...
        <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
          ...
          <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
            ...
            <p className="text-xl mb-10 text-gray-300 leading-relaxed">
              Regístrate hoy mismo y comienza a disfrutar de la comodidad de
              recibir tus bebidas favoritas sin salir de casa.
            </p>
