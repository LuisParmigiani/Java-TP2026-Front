          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div>
              ...
              <div className="flex flex-row items-center justify-between mb-8">
                <p className="text-muted-foreground text-lg">Descubre nuestras bebidas más populares.</p>
                <LinkButton name="Ver Todos los Productos" size="md" variant="outline" url="/products-showcase" />
              </div>
