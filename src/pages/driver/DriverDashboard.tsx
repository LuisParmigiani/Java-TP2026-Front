        ...
        const fetchData = async () => {
            try {
                ...
                const result = await getDriverInfo(token, [
                    'camion', 'carga', 'persona'
                ]);
                setUserData(result);
                console.log("User data:", result);
            } catch (err) {
                console.error("Error fetching user data:", err);
                const errorMessage = err instanceof Error ? err.message : "Error al obtener información del conductor";
            ...
            {userData ? (
                <>
                    ...
                    <div className='w-full p-5 items-center'>
                        <div className='grid grid-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-center "'>
                            <LinkButton
                                name="Ver Recrrido"
                                url="/driver/route"
                                variant="outline"
