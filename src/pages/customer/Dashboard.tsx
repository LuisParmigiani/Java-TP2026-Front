    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-1 py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10">
            <div className='flex felx-row  justify-around mb-3 '>
              <h1 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight">
                Bienvenido, {user?.persona?.nombre ?? ''} {user?.persona?.apellido ?? ''}!
              </h1>
              <LinkButton name="Editar Perfil" url="/customer/profile" variant="outline" size="sm" />
            </div>
            <p className="text-lg text-muted-foreground">Gestiona tus pedidos, entregas y saldo desde aquí.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            ...
            <InformationCard
              ...
              miniTitle="Productos" title={`Tienes ${containers} containers en su Hogar`} description="Los retornables son reutilizables por los que debera devolverlos a la hora de solicitar nuevos productos." cardColor="white" titleColor='primary' descriptionColor='gray' size="sm" />
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <LinkButton name="Pedido Semanal" url="/customer/weeklyOrder" variant="tertiary" size="lg" />
          ...
          <div>
            <div className="flex items-center justify-between flex-row mb-6">
              <h2 className="text-xl font-semibold text-foreground">Pedidos Recientes</h2>
              <LinkPhrase text="Ver Todos" url="/customer/orders" size="md" color="primary" />
            </div>
          ...
          <div>
            <div className="flex items-center justify-between flex-row m-6">
              <h2 className="text-xl font-semibold text-foreground">Direcciones</h2>
              <LinkPhrase text="Ver Todas" url="/customer/directions" size="md" color="primary" />
