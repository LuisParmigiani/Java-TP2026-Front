...
const recentOrders = [
    { id: '12345', date: '2024-09-01', status: 'Pendiente', total: '45.67' },
    { id: '12346', date: '2024-08-28', status: 'Entregado', total: '89.99' },
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                        ...
                        <InformationCard
                            ...
                            miniTitle="Saldo" title="$-1,234.56" description="Tu saldo actual es de $-1,234.56" cardColor="white" titleColor='red' descriptionColor='gray' size="sm" />
                        <InformationCard
                            ...
                            miniTitle="Productos" title="Tienes 5 Retornables en su Hogar" description="Los retornables son reutilizables por los que debera devolverlos a la hora de solicitar nuevos productos." cardColor="white" titleColor='primary' descriptionColor='gray' size="sm" />
                    </div>
