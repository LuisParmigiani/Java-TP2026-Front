...
const EmployeeManagement = () => {
  ...
  const [editingEmployee, setEditingEmployee] = useState<UserResponse | null>(
    null,
  );
          ...
          <EmployeeForm
            ...
            onSubmit={async (formData) => {
              if (editingEmployee) {
                ...
                console.log(
                  "Actualizando empleado con datos:",
                  updatedEmployee,
                );
                try {
                  ...
                  const errorMessage =
                    ...
                    "Error al actualizar empleado."; // FALLBACK
                  setError({
                    errorTitle: formattedError?.errorTitle || "Error",
                    errorMessage,
                  });
                  setShowAlert(true);
                  toast.error(errorMessage);
